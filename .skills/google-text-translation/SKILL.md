...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-cr8gr9rfgsn5-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-cr8gr9rfgsn5-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
