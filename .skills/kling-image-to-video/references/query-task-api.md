...
| Property | Value |
|----------|-------|
| **Endpoint** | `GET https://app-cr8gr9rfgsn5-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/{id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-cr8gr9rfgsn5-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
